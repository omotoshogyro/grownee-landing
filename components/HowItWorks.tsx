      ...
      <div className="w-full px-4 lg:px-[120px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-[40px] items-stretch">
          ...
          <motion.div
            ...
            className="relative bg-[#AFE47C] rounded-[32px] lg:rounded-[80px] overflow-hidden min-h-[500px] lg:min-h-auto flex items-center justify-center p-8 lg:p-16"
          >
            <div className="relative z-10 w-full max-w-sm lg:max-w-md">
              <Image
                ...
                width={400}
                height={800}
                className="w-full h-auto drop-shadow-2xl translate-y-8 lg:translate-y-12" 
                priority
              />
            </div>
          </motion.div>
